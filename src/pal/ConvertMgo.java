	...
	public static void main(String[] args) throws IOException {
		...
		for (int i = 21; i < 22; i++) {					//>570时 会报错 99396 > 59516
			...
			for (int j = 0; j < images.length; j++) {
				...
				BufferedImage bi = new BufferedImage(width, height, BufferedImage.TYPE_INT_RGB);		//RleUtil.decode
				bi.setRGB(0, 0, width, height, ArraysUtil.getArrays(data), 0, width);
				
				String name = String.format("%03d_%03d", i, j);
				String filePath = "G:\\LanGame\\pal\\study\\MKF2BMP\\mgo\\" + name + ".BMP";
